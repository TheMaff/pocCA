        ...
        sdk.run_inline_query({
          ...
          body: {
            ...
            fields: [
              ...
              'estado_camas_live.fecha_actualizacion',
              'estado_camas_live.fecha_autorizacion',
              'estado_camas_live.fecha_egreso_estimada_pabellon',
              'estado_camas_live.fecha_solicitud',
              'estado_camas_live.fechaaltaadmpaciente',
              'estado_camas_live.fechaaltamedicapaciente',
              'estado_camas_live.fechaaltaprobablepaciente',
              'estado_camas_live.last_fecha_encuentro',
              'estado_camas_live.tiempoultimoestado2',
              'estado_camas_live.vsrda_fecha_ingreso_adm'
            ],
